  ...
  return (
    <div className="relative w-full" style={{ padding: 'clamp(88px,12vh,150px) clamp(28px,7vw,110px) clamp(40px,6vh,80px)' }}>
      <div style={{ maxWidth: 920, margin: '0 auto', width: '100%' }}>
        ...
        <h2 style={{ fontFamily: SERIF, fontWeight: 700, fontSize: 'clamp(42px,7vw,96px)', letterSpacing: '-0.02em', lineHeight: 0.95, marginTop: 14, color: 'var(--oxblood)' }}>{chapter.title}</h2>
