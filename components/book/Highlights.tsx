  ...
  return (
    <div className="flex h-full w-full flex-col justify-center" style={{ padding: 'clamp(40px,6vw,84px) clamp(28px,7vw,110px)' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', width: '100%' }}>
        ...
        <h2 style={{ fontFamily: DISPLAY, fontWeight: 800, fontSize: 'clamp(30px,4.6vw,58px)', letterSpacing: '-0.02em', lineHeight: 1, marginBottom: 'clamp(20px,3vw,36px)' }}>The proof, in numbers.</h2>
          ...
          {highlights.map((h, i) => (
            ...
            >
              ...
              <div style={{ flex: '1 1 280px', minWidth: 0 }}>
                <span style={{ fontFamily: DISPLAY, fontWeight: 700, fontSize: 'clamp(20px,2.4vw,28px)' }}>{h.name}</span>
